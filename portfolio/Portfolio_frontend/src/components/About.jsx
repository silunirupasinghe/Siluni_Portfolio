    ...
    <>
      <section id="about" className="py-10">
        <div className="container mx-auto md:px-28 sm:px-auto">
          <h2 className="text-3xl md:text-4xl text-yellow-300 font-bold text-center">
            About Me
          </h2>
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-8 pl-4">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <h2 className="text-xl font-normal text-yellow-100">
                Anula Vidyalaya, Nugegoda (2008-2021)
                <br />
          ...
          <div className="mt-8">
            ...
            <h2 className="text-xl font-normal text-yellow-100 pl-4">
              EXPERIENCE
            </h2>
            <div className="mt-4 pl-8">
              <div className="relative">
                ...
                <div className="flex items-center mb-6 relative">
                  ...
                  <div className="ml-12">
                    <h3 className="text-lg font-normal text-yellow-100">
                      Associate Software Engineer
                    </h3>
                    <Link to="https://connexcodeworks.biz/">
                      <p>Connex Codeworks (Pvt) Ltd</p>
                    </Link>
                ...
                <div className="flex items-center mb-6 relative">
                  ...
                  <div className="ml-12">
                    ...
                    <span>October 2024 - Jan 2025</span>
                  </div>
                </div>
